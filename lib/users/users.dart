...
import 'package:gowi_app_admin/component/progress.dart';
import 'package:gowi_app_admin/provider/loading.dart';
import 'package:gowi_app_admin/users/add.dart';
import 'package:gowi_app_admin/users/users_data.dart';
...
class _UsersState extends State<Users> {
  ...
  bool loadingList = false;
   getDataUser(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
 ...
 _searchPressed(LoadingControl myProv) {
